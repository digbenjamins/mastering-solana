...
import { findAssociatedTokenPda, getRevokeInstruction, TOKEN_PROGRAM_ADDRESS } from "@solana-program/token";
...
const transactionMessage = pipe(
  ...
  (tx) => appendTransactionMessageInstructions([revokeInstruction], tx) // Append instructions
);
